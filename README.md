...
## Tools Used
- Power BI Desktop  
- Python with it's different libraries:  pandas, numpy, matplotlib, seaborn, scikit-learn  

## Setup (IMPORTANT)

1. Install Python Libraries by - pip install pandas numpy matplotlib seaborn scikit-learn
